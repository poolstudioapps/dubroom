...
export const es = {
  ...
  home: {
    ...
    kicker: 'El juego de doblaje entre amigos',
    ...
    reassure3: 'Nada se publica sin ti',
    ...
    value3: {
      title: 'Un vídeo para guardar',
      body: 'Al final, un vídeo con vuestras voces que se ve en cualquier parte y se comparte en un gesto. Descárgalo antes de una hora.',
    },
    ...
    seoTitle: 'El juego de doblaje de películas entre amigos',
    defineTitle: '¿Qué es doblar una escena de película?',
    defineBody:
      'Doblar una escena de película es sustituir las voces originales por las tuyas conservando todo lo demás: la imagen, la música, los efectos, el ritmo. El resultado no es un comentario encima, es la escena misma con otros actores. Dubblers es un software de doblaje en línea que hace ese trabajo en el navegador, sin instalar nada.',
    defineHowTitle: 'Cómo doblar una escena de película por tu cuenta',
    defineHowBody:
      'Hacen falta tres cosas que nadie tiene en casa: separar las voces de la música para sustituir solo las voces, saber quién habla y cuándo al milisegundo, y mantener la sincronía al hablar. Dubblers hace las dos primeras automáticamente a partir de la escena, y resuelve la tercera con una banda rítmica, el texto que pasa bajo un cabezal de lectura que los estudios de doblaje usan desde hace ochenta años.',
    ...
    faqExtra: [
      {
        q: '¿Es gratis?',
        a: 'Sí. Dubblers es un proyecto personal, sin publicidad, sin suscripción y sin límite de escenas.',
      },
      {
        q: '¿Qué es la comunidad?',
        a: 'El catálogo de escenas ya preparadas por otros jugadores: personajes, texto, cortes y sonido están listos. Traes el vídeo en MP4 y la sala se abre al instante. Los vídeos y vuestras voces nunca se comparten.',
      },
      {
        q: '¿En qué se diferencia de un montaje de vídeo normal?',
        a: 'Un programa de edición te da una línea de tiempo vacía. Dubblers parte de la escena: separa las voces de la música, localiza las frases, las asigna a los personajes y alinea tus tomas por sí solo.',
      },
      {
        q: '¿Se puede doblar una escena en otro idioma?',
        a: 'Sí. El idioma de la interfaz y el de la escena son independientes. El texto transcrito sirve de guía de ritmo: di lo que quieras encima.',
      },
      {
      ...
      },
      {
        ...
        a: 'Automáticamente, nada más importar: la escena se divide en dos, las voces por un lado y la música y los efectos por otro. Solo se sustituyen las voces, y todo lo demás sigue sincronizado con la imagen.',
      },
    ] as const,
    faq: [
      {
        q: '¿Qué necesito exactamente?',
        a: 'Unos auriculares con micrófono y un navegador, en ordenador o en móvil. Los auriculares importan: sin ellos, tu micro vuelve a grabar la música de la escena.',
      },
      {
        q: '¿Tenemos que estar todos a la vez?',
        a: 'No. Una vez elegidos los papeles, cada uno graba sus frases por su cuenta. El anfitrión lanza el montaje cuando todos han terminado.',
      },
      {
        q: '¿Hay que saber doblar?',
        a: 'No. El texto pasa bajo un cabezal de lectura, como en un estudio de verdad, y tu toma se alinea sola con la voz original. Una toma fallida se repite las veces que quieras.',
      },
      {
        q: '¿Cuánto tiempo lleva?',
        a: 'De dos a tres minutos de preparación tras la importación, y luego el tiempo de decir vuestras frases. Una escena de dos minutos se dobla en media hora entre tres.',
      },
      {
        q: '¿Qué nos queda al final?',
        a: 'Un vídeo con vuestras voces, que puedes descargar y compartir durante una hora, y una escena que podéis volver a doblar enseguida con los mismos jugadores. Después todo se borra, vuestras grabaciones y el vídeo original incluidos: nada se queda en nuestros servidores.',
      },
      {
        q: '¿Puedo invitar a quien quiera?',
        a: 'El acceso es por invitación: solo entran las direcciones de la lista de invitados. Para jugar una escena, basta con compartir su código o su enlace.',
      },
    ] as const,
    slides: {
  ...
  community: {
    ...
    recipeHelp: 'Los vídeos no se alojan aquí: cada escena guarda sus cortes y su sonido original. Para doblar una, traes su vídeo en MP4 y la sala se abre al instante.',
    ...
    removeBody:
      'Se borrarán la ficha y los cortes. Las escenas ya empezadas a partir de ella dejarán de funcionar. No se puede deshacer.',
    publish: 'Publicar en la comunidad',
    published: 'Esta escena está en la comunidad',
    seeInCommunity: 'Verla en la comunidad',
    publishRecipeHelp: 'Se comparten el enlace original, los cortes y el sonido de la escena. El vídeo nunca se aloja aquí y vuestras voces nunca se comparten.',
    ...
    publishUploadHelp: 'Se comparten los cortes, los personajes, el texto y el sonido de la escena. Tu vídeo se queda contigo: quienes vuelvan a jugar la escena traerán el suyo.',
    ...
    detailVideoBody: 'El catálogo guarda los cortes y el sonido, no el vídeo. Consíguelo desde el enlace original, o de donde quieras, e impórtalo: la guía muestra cómo en cinco minutos.',
    ...
    howSteps: [
      ...
      },
      {
        ...
        body: 'Dubblers separa las voces y divide las frases. Tú corriges los personajes y el texto.',
      },
      {
    ...
    publishAskBody: 'Tus cortes pueden servir a otros grupos: volverán a jugar la escena con su propio vídeo. Se comparten el enlace, los cortes y el sonido original, nunca vuestras voces.',
    ...
    previewMoreTitle: 'Y muchas más escenas para doblar',
    previewMoreBody: (n: number) => (n > 0 ? `Crea tu cuenta para explorar las ${n} escenas del catálogo, jugarlas con tus amigos y publicar las tuyas.` : 'Crea tu cuenta para explorar el catálogo, jugar las escenas con tus amigos y publicar las tuyas.'),
    previewCta: 'Ver más escenas',
    charactersToDub: (n: number) => (n === 1 ? '1 personaje para doblar' : `${n} personajes para doblar`),
    faqTitle: 'Preguntas sobre la comunidad',
    faq: [
      {
        q: '¿Qué es un pack?',
        a: 'Una escena ya preparada por otro jugador: personajes, texto, cortes y sonido original. Solo falta el vídeo, que traes tú, y vuestras voces.',
      },
      {
        q: '¿Por qué tengo que traer el vídeo?',
        a: 'Dubblers no aloja vídeos. Consíguelo desde el enlace de la ficha, o de donde quieras: solo tiene que ser el mismo, de principio a fin.',
      },
      {
        q: '¿Cómo publico mi propia escena?',
        a: 'Crea un pack desde la comunidad o publica una escena terminada desde la pantalla del resultado. Basta con un título, el enlace original, el idioma y el género.',
      },
      {
        q: '¿Para qué sirven los votos?',
        a: 'Valoran la calidad de los cortes, no la película. Las escenas mejor valoradas suben al principio del catálogo y sus creadores pueden obtener la certificación.',
      },
      {
        q: '¿Dónde edito o retiro mis packs?',
        a: 'En tu perfil público: ahí están todos tus packs, y puedes editarlos o retirarlos cuando quieras.',
      },
    ],
    pagination: {
  ...
  terms: {
    ...
    gateGist:
      'Lo esencial: tú respondes de los fragmentos que importas y de lo que haces con ellos. Nada se publica sin tu consentimiento.',
  ...
  legal: {
    ...
    terms: 'Condiciones',
    usageNotice:
      'Las escenas y las voces se quedan entre invitados: la comunidad solo ve las fichas de los packs compartidos.',
    contact: 'Contacto',
    contactEmail: 'ienders.pro@gmail.com',
    cookies: 'Cookies',
    footerNav: 'Enlaces del pie de página',
    footerTagline: 'El juego de doblaje de películas entre amigos: cada uno su frase, y la sorpresa todos juntos al final.',
  ...
  sessions: {
    ...
    deleteConfirmBody:
      'Se borrarán el vídeo final, las tomas y todo lo relativo a la escena. No se puede deshacer.',
    joinByCode: 'Entrar con un código',
    join: 'Entrar',
    storageTitle: 'Espacio usado',
    storageHelp:
      'El vídeo original, el sonido separado y las tomas se borran una hora después del montaje, junto con el vídeo final. Borrar una escena libera su espacio al momento.',
  ...
  create: {
    ...
    wrongType: 'Solo se aceptan archivos MP4. Convierte tu vídeo a MP4: la guía de importación explica cómo.',
    ...
    introPack: 'Personajes, frases y sonido ya están listos: traes el vídeo en MP4 y la sala se abre al instante.',
    introYoutube: 'Solo para administradores: el vídeo lo descarga el ordenador del anfitrión, que debe estar encendido.',
    limits: 'Archivo MP4 · 50 MB y 10 minutos como máximo',
  ...
  ingest: {
    ...
    queued:
      'La preparación empieza en un momento.',
    queuedHelp:
      'Suele empezar en segundos. Si la espera se alarga, relanza la importación o avisa al anfitrión.',
  ...
  studio: {
    ...
    micOffsetHelp: 'Tu toma se alinea sola con la voz original. Si aún cae un poco tarde, baja el valor; un poco pronto, súbelo. También puedes arrastrar tu pista sobre la forma de onda.',
    ...
    fxReverb: 'Reverb',
    fxPitch: 'Pitch',
    fxHelp: 'Todo se oye al instante al reproducir tu toma, tal cual en el vídeo final. Los efectos nunca tocan tu grabación: puedes cambiarlos hasta el montaje.',
    fxPresets: {
      dry: 'Voz limpia',
      room: 'Sala pequeña',
      cathedral: 'Catedral',
    ...
    fxKeep: 'Mantener estos efectos en la siguiente toma',
  ...
  render: {
    ...
    queued:
      'El montaje empieza en un momento.',
    ...
    keepNotice: (minutes: number) => `Cuando esté listo, tu vídeo seguirá disponible ${minutes} minutos: descárgalo antes de que se borre.`,
  },

  result: {
    title: 'El resultado',
    download: 'Descargar el vídeo',
    ...
    redoTitle: '¿Otra vez?',
    redoBody: 'Misma escena, mismos jugadores: todos vuelven a la sala, cada uno puede cambiar de personaje y no hay nada que preparar.',
    redoAction: 'Volver a doblar la escena',
    redoConfirmTitle: '¿Empezar una nueva ronda?',
    redoConfirmBody: 'Todos vuelven a la sala con la misma escena. Las tomas de esta ronda se borran y el vídeo actual se eliminará: descárgalo antes si quieres conservarlo.',
    redoGuest: 'El anfitrión puede empezar una nueva ronda: volveréis todos a la sala con la misma escena.',
    redoUnavailable: 'Los archivos de esta escena se han borrado: para volver a jugarla, empiézala desde la comunidad o importa de nuevo el vídeo.',
  },

  packStart: {
    intro: 'El catálogo guarda los cortes y el sonido de esta escena, no su vídeo: hay que traerlo. Hay dos maneras.',
    fileTitle: 'Importar y doblar',
    fileBody: 'Suelta el vídeo de la escena en MP4: la sala se abre en cuanto termina la subida. El texto y los personajes del pack se mantienen tal cual.',
    openSource: 'Ver el vídeo original',
    howTo: '¿Cómo consigo el archivo?',
    drop: 'Suelta el vídeo aquí o haz clic para elegirlo',
    expected: (d: string) => `Duración esperada: ${d} · MP4, 50 MB máximo`,
    ...
    introMember: 'El catálogo guarda los cortes y el sonido de esta escena: trae su vídeo en MP4 y la sala se abre al instante.',
  ...
  guide: {
    ...
    heroBody: 'Dubblers importa archivos MP4, vengan de donde vengan: YouTube, TikTok, una película en tu disco, una grabación de pantalla. Las escenas del catálogo guardan sus cortes y su sonido, no la imagen: para doblar una, traes el vídeo. Cuatro pasos, cinco minutos.',
    ...
    steps: [
      ...
      },
      {
        ...
        body: 'Guarda el vídeo en MP4 con la herramienta que prefieras, o convierte un archivo que ya tengas. Apunta a 720p, o 480p si el archivo supera los 50 MB.',
      },
      {
        title: 'Comprueba la duración',
        body: 'El vídeo debe ser exactamente el del pack: mismo inicio, mismo final. Dubblers compara la duración y te avisa si no coincide.',
      },
      {
        title: 'Importa y dobla',
        body: 'Vuelve a la escena y suelta ahí el archivo. La sala se abre en cuanto termina la subida.',
      },
    ],
    ...
    wayFileBody: 'Funciona a cualquier hora, sin instalar nada. Para un pack, la sala se abre en cuanto termina la subida.',
    faqTitle: 'Preguntas frecuentes',
    faq: [
      {
        q: '¿Qué formatos se aceptan?',
        a: 'Solo MP4, el formato de casi todas las herramientas de descarga y exportación. Un .mov, .mkv o .avi se convierte a MP4 en segundos con una herramienta como HandBrake; en iPhone, elige «Más compatible» en Ajustes › Cámara › Formatos.',
      },
      {
    ...
    finalBody: 'Elige una escena del catálogo, consigue su vídeo en MP4 y la sala se abre al instante.',
    ...
    homeBannerTitle: 'Cualquier vídeo, en MP4',
    homeBannerBody: 'YouTube, TikTok, una película en tu disco, una grabación de pantalla: todo se importa, siempre que sea un archivo MP4. La guía explica cómo conseguirlo y prepararlo en cinco minutos.',
  ...
  guideHub: {
    ...
    tips: [
      {
        title: 'Auriculares, siempre',
        body: 'Sin auriculares, la música vuelve a entrar en el micro y se oye dos veces en el vídeo final.',
      },
      {
        title: 'Escucha primero la versión original',
        body: 'El ritmo de la frase original es tu mejor guía.',
      },
      {
        title: 'Deja trabajar la sincronización',
        body: 'Tu toma se alinea sola con la voz original; arrástrala a mano si hace falta.',
      },
      {
  ...
  admin: {
    ...
    help: 'Un administrador también puede crear una escena desde un enlace de YouTube: el vídeo lo descarga entonces su ordenador. Los demás miembros importan sus vídeos, que se preparan en línea.',
  ...
  guides: {
    ...
    studio: {
      ...
      steps: [
        ...
        },
        {
          ...
          body: 'Volumen, reverb, pitch: cada ajuste vale para la toma en pantalla y se oye al momento. Marca «Mantener estos efectos» para llevarlos a la frase siguiente, y arrastra tu pista si cae un poco pronto o un poco tarde.',
        },
      ],
    ...
    prepare: {
      ...
      intro: 'Tras la importación, Dubblers detecta los personajes y divide las frases. Unos minutos de revisión y cada uno sabrá exactamente qué interpretar.',
    ...
    publish: {
      ...
      intro: 'Una escena bien preparada puede servir a otros grupos. Publicar comparte los cortes (personajes, texto, marcas) y el sonido de la escena original. Nunca el vídeo, nunca vuestras voces.',
      readingTime: '3 min de lectura',
      stepsTitle: 'En cuatro pasos',
      steps: [
        {
  ...
  cookies: {
    ...
    bannerBody: 'Dubblers solo usa las cookies necesarias para mantener tu sesión. Con tu permiso, también recuerda tus preferencias: tu idioma, tu dirección de acceso, tus ajustes del estudio. Sin publicidad ni seguimiento.',
    policyLink: 'Más información',
    customize: 'Personalizar',
    refuse: 'Rechazar',
    accept: 'Aceptar todo',
    settingsTitle: 'Gestionar las cookies',
    settingsBody: 'Elige lo que Dubblers puede guardar en tu navegador. Puedes cambiar de opinión cuando quieras desde el pie de cada página.',
  ...
  creators: {
    ...
    statScenes: 'Escenas jugadas',
    statCharacters: 'Personajes doblados',
    topCharacterTitle: 'Personaje más doblado',
    topCharacterBody: (duree: string, n: number) => `${duree} de doblaje en ${n} escena${n > 1 ? 's' : ''}`,
    topCharacterNone: 'Aún ninguna escena terminada.',
  },
  ...
  notifications: {
    ...
    label: (n: number) => (n === 0 ? 'Notificaciones' : `Notificaciones, ${n} nueva${n > 1 ? 's' : ''}`),
    renderStarted: (title: string) => `Ha empezado el montaje de «${title}».`,
    renderDone: (title: string) => `«${title}» está lista: mírala y descárgala.`,
    renderExpiring: (title: string, minutes: number) => `«${title}» se borrará en ${minutes} min: acuérdate de descargarla.`,
    renderDeleted: (title: string) => `El vídeo de «${title}» se ha borrado.`,
    packLike: (who: string, others: number, title: string) => (others === 0 ? `A ${who} le ha gustado «${title}»` : `A ${who} y ${others} más les ha gustado «${title}»`),
    packComment: (who: string, others: number, title: string) => (others === 0 ? `${who} ha comentado «${title}»` : `${who} y ${others} más han comentado «${title}»`),
    profileComment: (who: string, others: number) => (others === 0 ? `${who} ha escrito en tu perfil` : `${who} y ${others} más han escrito en tu perfil`),
    reply: (who: string, others: number) => (others === 0 ? `${who} ha respondido a tu comentario` : `${who} y ${others} más han respondido a tu comentario`),
    recent: 'Nuevas',
    earlier: 'Anteriores',
    newCount: (n: number) => (n === 1 ? '1 nueva' : `${n} nuevas`),
  },
