...
export const zh = {
  ...
  packStart: {
    intro: '这个场景以链接形式保存，需要重新获取视频。有两种方式。',
    recommended: '推荐',
    fileTitle: '自己导入视频',
    fileBody: '获取该场景的 YouTube 视频，然后把文件拖到这里。无需主持人的电脑，约两分钟即可在线完成准备。素材包里的台词和角色会原样沿用。',
    openSource: '在 YouTube 上观看视频',
    howTo: '如何获取文件？',
    drop: '把视频拖到这里，或点击选择',
    expected: (d: string) => `预计时长：${d} · MP4，最大 50 MB`,
    mismatch: (expected: string, got: string) => `这个文件时长 ${got}，素材包的场景时长 ${expected}。如果不是完全相同的视频，台词会对不上。`,
    tooLarge: '文件太大：最大 50 MB。请获取 720p 或 480p 的视频。',
    fileSubmit: '导入并配音',
    or: '或',
    autoTitle: '自动下载',
  ...
  guide: {
    metaTitle: '用自己的视频为场景配音',
    kicker: '指南',
    heroTitle: '用自己的视频为目录中的场景配音',
    heroBody: '目录中的场景只保存 YouTube 链接和准备工作。要为它配音，需要视频本身。最简单的办法：自己获取视频，然后导入。四个步骤，五分钟。',
    ctaPrimary: '选择场景',
    ctaSecondary: '为什么需要这一步？',
    stepsTitle: '四个步骤',
    steps: [
      {
        title: '在 YouTube 上打开场景',
        body: '在社区中打开想配音的场景，点击“在 YouTube 上观看视频”链接，复制页面地址。',
      },
      {
        title: '获取文件',
        body: '把地址粘贴到你选择的下载工具中，保存为 MP4。选择 720p；如果文件超过 50 MB，就选 480p。',
      },
      {
        title: '核对时长',
        body: '视频必须与素材包完全一致：开头相同，结尾相同。Dub’Up 会比较时长，不一致时会提醒你。',
      },
      {
        title: '导入并配音',
        body: '回到场景，把文件拖进“自己导入视频”。准备在线完成，随后大厅就会打开。',
      },
    ],
    checklistTitle: '导入之前',
    checklist: [
    ...
    faq: [
      {
        q: '用什么工具下载？',
        a: '任何能把 YouTube 视频保存为 MP4 的工具都可以。避开要求安装扩展或未知软件的工具，并且只下载你有权私下使用的视频。',
      },
      {
        q: '我的文件超过 50 MB',
        a: '用更低的清晰度下载：720p，长场景用 480p。在工作室里画面依然清晰，声音也不受影响。',
      },
      {
        q: '台词对不上',
        a: '视频与素材包不完全一致：多了片头、结尾被剪，或是另一个上传版本。请使用素材包的链接获取那个视频。',
      },
      {
        q: '视频已经不在 YouTube 上了',
        a: '没有原视频，这个场景就无法配音。可以把另一个版本作为新场景导入，它会重新准备。',
      },
    ],
    finalTitle: '准备好配音了吗？',
