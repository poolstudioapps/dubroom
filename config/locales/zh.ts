...
export const zh = {
  ...
  home: {
    ...
    faqExtra: [
      ...
      {
        q: '社区是什么？',
        a: '其他玩家已经准备好的场景目录：角色、台词、分段和声音都已就绪。你带上视频，大约一分钟后大厅就会打开。视频和你们的声音永远不会被分享。',
      },
      {
        q: '和普通视频剪辑有什么不同？',
  ...
  community: {
    ...
    kindRecipe: '配方',
    kindMedia: '保留文件',
    recipeHelp: '这里不存放视频：每个场景保存的是分段和原始声音。要为它配音，带上视频即可，大约一分钟后大厅就会打开。',
  ...
  packStart: {
    ...
    introMember: '目录保存了这个场景的分段和声音：带上视频，大约一分钟后大厅就会打开。',
    importAnyway: '仍然导入',
    otherFile: '选择其他文件',
  },
  ...
  guide: {
    ...
    heroBody: 'Dubblers 接受任何视频文件，无论格式和来源：YouTube、TikTok、硬盘上的电影、录屏都可以。目录中的场景保存的是分段和声音，不包括画面：要配音，你需要带上视频。四个步骤，五分钟。',
    ctaPrimary: '选择场景',
