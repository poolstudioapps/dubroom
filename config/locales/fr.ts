...
export const fr = {
  ...
  home: {
    ...
    faqExtra: [
      ...
      },
      {
        ...
        a: 'Le catalogue des scènes déjà préparées par d’autres joueurs : personnages, texte, découpage et son sont prêts. Tu apportes la vidéo en MP4, et le lobby s’ouvre aussitôt. Les vidéos et vos voix ne sont jamais partagées.',
      },
      {
  ...
  community: {
    ...
    recipeHelp: 'Les vidéos ne sont pas hébergées ici : chaque scène garde son découpage et son son d’origine. Pour en doubler une, tu apportes sa vidéo en MP4, et le lobby s’ouvre aussitôt.',
  ...
  create: {
    ...
    wrongType: 'Seuls les fichiers MP4 sont acceptés. Convertis ta vidéo en MP4 : le guide d’import explique comment.',
    ...
    introPack: 'Personnages, répliques et son sont déjà prêts : tu apportes la vidéo en MP4, et le lobby s’ouvre aussitôt.',
    introYoutube: 'Réservé aux administrateurs : la vidéo est récupérée par l’ordinateur de l’hôte, qui doit être allumé.',
    limits: 'Fichier MP4 · 50 Mo et 10 minutes au plus',
  ...
  packStart: {
    ...
    fileBody: 'Dépose la vidéo de la scène, en MP4 : le lobby s’ouvre dès l’envoi terminé. Le texte et les personnages du pack sont repris tels quels.',
    ...
    introMember: 'Le catalogue garde le découpage et le son de cette scène : apporte sa vidéo en MP4, et le lobby s’ouvre aussitôt.',
  ...
  guide: {
    ...
    heroBody: 'Dubblers importe des fichiers MP4, d’où qu’ils viennent : YouTube, TikTok, un film sur ton disque, un enregistrement d’écran. Les scènes du catalogue gardent leur découpage et leur son, pas l’image : pour en doubler une, tu apportes la vidéo. Quatre étapes, cinq minutes.',
    ...
    steps: [
      ...
      },
      {
        ...
        body: 'Enregistre la vidéo en MP4 avec l’outil de ton choix, ou convertis un fichier que tu as déjà. Vise 720p, ou 480p si le fichier dépasse 50 Mo.',
      },
      {
      ...
      },
      {
        ...
        body: 'Reviens sur la scène et dépose-y le fichier. Le lobby s’ouvre dès l’envoi terminé.',
      },
    ],
    ...
    wayFileBody: 'Marche à toute heure, sans rien installer. Pour un pack, le lobby s’ouvre dès l’envoi terminé.',
    faqTitle: 'Questions fréquentes',
    faq: [
      {
        q: 'Quels formats sont acceptés ?',
        a: 'Le MP4 uniquement, le format de presque tous les outils de téléchargement et d’export. Un .mov, un .mkv ou un .avi se convertit en MP4 en quelques secondes avec un outil comme HandBrake ; sur iPhone, choisis « Le plus compatible » dans Réglages › Appareil photo › Formats.',
      },
      {
    ...
    finalBody: 'Choisis une scène dans le catalogue, récupère sa vidéo en MP4, et le lobby s’ouvre aussitôt.',
    ...
    homeBannerTitle: 'N’importe quelle vidéo, en MP4',
    homeBannerBody: 'YouTube, TikTok, un film sur ton disque, un enregistrement d’écran : tout s’importe, du moment que c’est un fichier MP4. Le guide montre comment le récupérer et le préparer en cinq minutes.',
  ...
  creators: {
    ...
    statScenes: 'Scènes jouées',
    statCharacters: 'Personnages doublés',
    topCharacterTitle: 'Personnage le plus doublé',
    topCharacterBody: (duree: string, n: number) => `${duree} de doublage sur ${n} scène${n > 1 ? 's' : ''}`,
    topCharacterNone: 'Pas encore de scène terminée.',
  },
