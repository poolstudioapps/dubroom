...
export const de = {
  ...
  home: {
    ...
    faqExtra: [
      ...
      },
      {
        ...
        a: 'Der Katalog der Szenen, die andere Spieler schon vorbereitet haben: Figuren, Text, Timing und Ton sind fertig. Du bringst das Video als MP4 mit, und die Lobby öffnet sich sofort. Videos und eure Stimmen werden nie geteilt.',
      },
      {
  ...
  community: {
    ...
    recipeHelp: 'Videos werden hier nicht gespeichert: Jede Szene behält ihr Timing und ihren Originalton. Um eine zu synchronisieren, bringst du ihr Video als MP4 mit, und die Lobby öffnet sich sofort.',
  ...
  create: {
    ...
    wrongType: 'Nur MP4-Dateien werden akzeptiert. Wandle dein Video in MP4 um: Der Import-Guide zeigt, wie.',
    ...
    introPack: 'Figuren, Sätze und Ton sind schon fertig: Du bringst das Video als MP4 mit, und die Lobby öffnet sich sofort.',
    introYoutube: 'Nur für Administratoren: Das Video lädt der Computer des Gastgebers herunter, der eingeschaltet sein muss.',
    limits: 'MP4-Datei · höchstens 50 MB und 10 Minuten',
  ...
  packStart: {
    ...
    fileBody: 'Leg das Video der Szene als MP4 ab: Die Lobby öffnet sich, sobald der Upload fertig ist. Text und Figuren des Packs bleiben, wie sie sind.',
    openSource: 'Originalvideo ansehen',
    howTo: 'Wie komme ich an die Datei?',
    drop: 'Video hier ablegen oder zum Auswählen klicken',
    expected: (d: string) => `Erwartete Dauer: ${d} · MP4, max. 50 MB`,
    ...
    introMember: 'Der Katalog speichert Timing und Ton dieser Szene: Bring ihr Video als MP4 mit, und die Lobby öffnet sich sofort.',
  ...
  guide: {
    ...
    heroBody: 'Dubblers importiert MP4-Dateien, egal woher: YouTube, TikTok, ein Film auf deiner Festplatte, eine Bildschirmaufnahme. Die Szenen im Katalog behalten Timing und Ton, nicht das Bild: Um eine zu synchronisieren, bringst du das Video mit. Vier Schritte, fünf Minuten.',
    ...
    steps: [
      ...
      },
      {
        ...
        body: 'Speichere das Video mit einem Werkzeug deiner Wahl als MP4 oder wandle eine vorhandene Datei um. Ziel: 720p, oder 480p, wenn die Datei über 50 MB liegt.',
      },
      {
      ...
      },
      {
        ...
        body: 'Geh zurück zur Szene und leg die Datei dort ab. Die Lobby öffnet sich, sobald der Upload fertig ist.',
      },
    ],
    ...
    wayFileBody: 'Funktioniert jederzeit, ohne Installation. Bei einem Pack öffnet sich die Lobby, sobald der Upload fertig ist.',
    faqTitle: 'Häufige Fragen',
    faq: [
      {
        q: 'Welche Formate werden akzeptiert?',
        a: 'Nur MP4, das Format fast aller Download- und Export-Werkzeuge. Eine .mov-, .mkv- oder .avi-Datei lässt sich mit einem Werkzeug wie HandBrake in Sekunden in MP4 umwandeln; am iPhone wähle „Maximale Kompatibilität“ unter Einstellungen › Kamera › Formate.',
      },
      {
    ...
    finalBody: 'Wähle eine Szene im Katalog, besorg dir ihr Video als MP4, und die Lobby öffnet sich sofort.',
    ...
    homeBannerTitle: 'Jedes Video, als MP4',
    homeBannerBody: 'YouTube, TikTok, ein Film auf deiner Festplatte, eine Bildschirmaufnahme: Alles lässt sich importieren, solange es eine MP4-Datei ist. Der Guide zeigt, wie du sie besorgst und in fünf Minuten vorbereitest.',
    homeBannerAction: 'Import-Anleitung lesen',
    midLink: 'Noch kein Video zur Hand? Die Anleitung erklärt, wie du eins bekommst.',
    trajetFile: 'MP4 · max. 50 MB',
  },
  ...
  creators: {
    ...
    statScenes: 'Gespielte Szenen',
    statCharacters: 'Synchronisierte Figuren',
    topCharacterTitle: 'Am häufigsten gesprochene Figur',
    topCharacterBody: (duree: string, n: number) => `${duree} Synchronisation in ${n} Szene${n > 1 ? 'n' : ''}`,
    topCharacterNone: 'Noch keine abgeschlossene Szene.',
  },
