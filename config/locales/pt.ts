...
export const pt = {
  ...
  create: {
    ...
    keepHelpUpload:
      'Apenas cenas criadas a partir de uma ligação podem entrar na comunidade. Um ficheiro importado fica privado ao teu grupo: nunca voltamos a alojar a obra.',
  ...
  packStart: {
    intro: 'Esta cena está guardada como link: é preciso buscar o vídeo de novo. Há duas maneiras.',
    recommended: 'Recomendado',
    fileTitle: 'Importar o vídeo você mesmo',
    fileBody: 'Obtenha o vídeo do YouTube da cena e solte o arquivo aqui. Tudo é preparado online, em cerca de dois minutos, sem o PC do anfitrião. O texto e os personagens do pack são reaproveitados como estão.',
    openSource: 'Ver o vídeo no YouTube',
    howTo: 'Como obtenho o arquivo?',
    drop: 'Solte o vídeo aqui ou clique para escolhê-lo',
    expected: (d: string) => `Duração esperada: ${d} · MP4, no máximo 50 MB`,
    ...
    tooLarge: 'Arquivo pesado demais: no máximo 50 MB. Obtenha o vídeo em 720p ou 480p.',
    fileSubmit: 'Importar e dublar',
    or: 'ou',
  ...
  guide: {
    metaTitle: 'Dublar uma cena com o seu próprio vídeo',
    kicker: 'Guia',
    heroTitle: 'Duble uma cena do catálogo com o seu próprio vídeo',
    heroBody: 'As cenas do catálogo guardam só o link do YouTube e o trabalho de preparação. Para dublar uma, é preciso o vídeo. O mais simples: obtê-lo você mesmo e importá-lo. Quatro passos, cinco minutos.',
    ctaPrimary: 'Escolher uma cena',
    ctaSecondary: 'Por que esta etapa?',
    stepsTitle: 'Em quatro passos',
    steps: [
      {
        title: 'Abra a cena no YouTube',
        body: 'Na Comunidade, abra a cena que quer dublar e siga o link «Ver o vídeo no YouTube». Copie o endereço da página.',
      },
      {
        title: 'Obtenha o arquivo',
        body: 'Cole o endereço na ferramenta de download que preferir e salve o vídeo em MP4. Escolha 720p, ou 480p se o arquivo passar de 50 MB.',
      },
      {
        title: 'Confira a duração',
        body: 'O vídeo tem de ser exatamente o do pack: mesmo início, mesmo fim. O Dub’Up compara a duração e avisa se for diferente.',
      },
      {
        title: 'Importe e duble',
        body: 'De volta à cena, solte o arquivo em «Importar o vídeo você mesmo». A preparação acontece online e depois o lobby abre.',
      },
    ],
    ...
    faq: [
      {
        q: 'Que ferramenta uso para baixar?',
        a: 'Qualquer ferramenta que salve um vídeo do YouTube em MP4. Evite as que pedem para instalar uma extensão ou um programa desconhecido, e baixe apenas vídeos que você tem o direito de usar em privado.',
      },
      {
        q: 'Meu arquivo passa de 50 MB',
        a: 'Baixe numa qualidade menor: 720p, ou 480p para uma cena longa. A imagem continua nítida no estúdio e o som não sofre.',
      },
      {
        q: 'As falas caem fora do tempo',
        a: 'O vídeo não é exatamente o do pack: uma introdução a mais, um final cortado ou outro envio. Use o link do pack e obtenha esse.',
      },
      {
        q: 'O vídeo não está mais no YouTube',
        a: 'Sem o vídeo original, a cena não pode ser dublada. Importe outra versão como nova cena: ela será preparada do zero.',
      },
    ],
