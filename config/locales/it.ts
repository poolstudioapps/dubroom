...
export const it = {
  ...
  home: {
    ...
    faqExtra: [
      ...
      },
      {
        ...
        a: 'Il catalogo delle scene già preparate da altri giocatori: personaggi, testo, tagli e audio sono pronti. Porti il video in MP4 e la lobby si apre subito. I video e le vostre voci non vengono mai condivisi.',
      },
      {
  ...
  community: {
    ...
    recipeHelp: 'I video non sono ospitati qui: ogni scena conserva i suoi tagli e il suo audio originale. Per doppiarne una, porti il suo video in MP4 e la lobby si apre subito.',
    ...
    howSteps: [
      {
        ...
        body: 'Titolo, link del video originale, lingua, genere e tag: ciò che vedrà la community.',
      },
      {
      ...
      },
      {
        ...
        body: 'Il pack entra nella community. Poi puoi doppiarlo con il tuo gruppo.',
      },
    ],
    ...
    linkLabel: 'Link del video originale',
  ...
  create: {
    ...
    wrongType: 'Sono accettati solo file MP4. Converti il tuo video in MP4: la guida all’importazione spiega come.',
    ...
    introPack: 'Personaggi, battute e audio sono già pronti: porti il video in MP4 e la lobby si apre subito.',
    introYoutube: 'Solo per gli amministratori: il video viene scaricato dal computer dell’host, che deve essere acceso.',
    limits: 'File MP4 · 50 MB e 10 minuti al massimo',
    ...
    communityBody: 'Prima la scheda e il video, poi il controllo della preparazione. Una volta pubblicato il pack, potrai giocarlo con il tuo gruppo.',
    ...
    packFicheTitle: 'La scheda del pack',
    packVideoTitle: 'Il video da dividere',
    packSubmit: 'Importa e prepara il pack',
    packYoutubeNeeded: 'Per importare da YouTube, il link della scheda deve essere un video di YouTube.',
    packNeedsVideo: 'Aggiungi il video della scena per continuare.',
  },
  ...
  prepare: {
    ...
    packPublish: 'Pubblica il pack',
    packPublishBody: 'Controlla la scheda un’ultima volta: è ciò che vedrà la community. La preparazione viene pubblicata così com’è sullo schermo.',
    packPublishedTitle: 'Il tuo pack è pubblicato',
    packPublishedBody: 'È nella community: altri gruppi possono scoprirlo, commentarlo e rigiocarlo con il loro video. Ora tocca a te.',
    packPlay: 'Gioca questo pack ora',
  ...
  studio: {
    ...
    devicesTitle: 'Microfono e cuffie',
    devicesLocked: 'Consenti il microfono per scegliere tra i tuoi dispositivi: prima il browser non ne mostra i nomi.',
    devicesAllow: 'Consenti il microfono',
    deviceMic: 'Microfono',
    deviceOutput: 'Uscita (cuffie)',
    deviceDefault: 'Predefinito di sistema',
    deviceOutputUnsupported: 'Il tuo browser invia l’audio all’uscita di sistema: scegli le cuffie nelle impostazioni del dispositivo.',
    devicesHelp: 'La scelta vale per tutte le registrazioni e resta memorizzata per la prossima volta.',
  ...
  packStart: {
    ...
    fileBody: 'Trascina il video della scena in MP4: la lobby si apre appena finisce il caricamento. Il testo e i personaggi del pack restano così come sono.',
    openSource: 'Vedi il video originale',
    howTo: 'Come recupero il file?',
    drop: 'Trascina qui il video o clicca per sceglierlo',
    expected: (d: string) => `Durata prevista: ${d} · MP4, 50 MB al massimo`,
    ...
    introMember: 'Il catalogo conserva i tagli e l’audio di questa scena: porta il suo video in MP4 e la lobby si apre subito.',
  ...
  guide: {
    ...
    heroBody: 'Dubblers importa file MP4, da qualunque parte arrivino: YouTube, TikTok, un film sul tuo disco, una registrazione dello schermo. Le scene del catalogo conservano tagli e audio, non l’immagine: per doppiarne una, porti il video. Quattro passaggi, cinque minuti.',
    ...
    steps: [
      ...
      },
      {
        ...
        body: 'Salva il video in MP4 con lo strumento che preferisci, o converti un file che hai già. Punta a 720p, o 480p se il file supera i 50 MB.',
      },
      {
      ...
      },
      {
        ...
        body: 'Torna sulla scena e trascinaci il file. La lobby si apre appena finisce il caricamento.',
      },
    ],
    ...
    wayFileBody: 'Funziona a qualsiasi ora, senza installare nulla. Per un pack, la lobby si apre appena finisce il caricamento.',
    faqTitle: 'Domande frequenti',
    faq: [
      {
        q: 'Quali formati sono accettati?',
        a: 'Solo MP4, il formato di quasi tutti gli strumenti di download ed esportazione. Un .mov, .mkv o .avi si converte in MP4 in pochi secondi con uno strumento come HandBrake; su iPhone, scegli «Più compatibile» in Impostazioni › Fotocamera › Formati.',
      },
      {
    ...
    finalBody: 'Scegli una scena nel catalogo, procurati il suo video in MP4 e la lobby si apre subito.',
    ...
    homeBannerTitle: 'Qualsiasi video, in MP4',
    homeBannerBody: 'YouTube, TikTok, un film sul tuo disco, una registrazione dello schermo: tutto si importa, purché sia un file MP4. La guida spiega come procurartelo e prepararlo in cinque minuti.',
      ...
      steps: [
        {
          ...
          body: 'Si pubblica dalla schermata del risultato dopo il render, o direttamente dalla preparazione se hai iniziato con «Crea un pack» nella community. Pubblica l’host.',
        },
        {
          title: 'Compila la scheda',
          body: 'Titolo, link del video originale, lingua e genere sono obbligatori: il link fa da anteprima e permette agli altri di recuperare il video. Aggiungi tag come #starwars perché la si trovi nella ricerca.',
        },
        {
  ...
  creators: {
    ...
    statScenes: 'Scene giocate',
    statCharacters: 'Personaggi doppiati',
    topCharacterTitle: 'Personaggio più doppiato',
    topCharacterBody: (duree: string, n: number) => `${duree} di doppiaggio in ${n} scen${n > 1 ? 'e' : 'a'}`,
    topCharacterNone: 'Ancora nessuna scena finita.',
  },
