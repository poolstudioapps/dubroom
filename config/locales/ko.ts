...
export const ko = {
  ...
  home: {
    ...
    faqExtra: [
      ...
      {
        q: '커뮤니티는 뭔가요?',
        a: '다른 플레이어가 미리 준비한 장면 카탈로그예요. 캐릭터, 대본, 구간, 소리가 준비돼 있어요. 영상을 MP4로 가져오면 로비가 바로 열려요. 영상과 여러분의 목소리는 절대 공유되지 않아요.',
      },
      {
  ...
  community: {
    ...
    kindRecipe: '레시피',
    kindMedia: '파일 보관',
    recipeHelp: '영상은 여기에 저장되지 않아요. 각 장면은 구간 정보와 원래 소리만 보관해요. 더빙하려면 영상을 MP4로 가져오세요. 로비가 바로 열려요.',
  ...
  create: {
    ...
    wrongType: 'MP4 파일만 받아요. 영상을 MP4로 변환하세요. 방법은 가져오기 가이드에 있어요.',
    youtubeLabel: '영상 링크',
    ...
    introPack: '캐릭터, 대사, 소리는 이미 준비돼 있어요. 영상을 MP4로 가져오면 로비가 바로 열려요.',
    introYoutube: '관리자 전용: 영상은 호스트의 컴퓨터가 내려받으며, 컴퓨터가 켜져 있어야 해요.',
    limits: 'MP4 파일 · 최대 50MB, 10분',
  ...
  packStart: {
    ...
    fileTitle: '불러와서 더빙하기',
    fileBody: '장면 영상을 MP4로 놓아 주세요. 업로드가 끝나면 로비가 바로 열려요. 팩의 대본과 캐릭터는 그대로 사용돼요.',
    openSource: '원본 영상 보기',
    howTo: '파일은 어떻게 준비하나요?',
    drop: '여기에 영상을 놓거나 클릭해서 선택하세요',
    expected: (d: string) => `예상 길이: ${d} · MP4, 최대 50MB`,
    ...
    introMember: '이 장면의 구간 정보와 소리는 카탈로그에 있어요. 영상을 MP4로 가져오면 로비가 바로 열려요.',
  ...
  guide: {
    ...
    heroBody: 'Dubblers는 MP4 파일이라면 출처와 상관없이 가져올 수 있어요. YouTube, TikTok, 내 디스크의 영화, 화면 녹화까지. 카탈로그 장면에는 구간 정보와 소리만 있고 화면은 없어요. 더빙하려면 영상을 가져오세요. 4단계, 5분이면 돼요.',
    ctaPrimary: '장면 고르기',
    ...
    steps: [
      ...
      {
        title: '파일 준비하기',
        body: '원하는 도구로 영상을 MP4로 저장하거나, 가지고 있는 파일을 MP4로 변환하세요. 720p, 파일이 50MB를 넘으면 480p를 권장해요.',
      },
      {
        title: '길이 확인하기',
      ...
      {
        title: '불러오고 더빙하기',
        body: '장면으로 돌아가 파일을 놓으세요. 업로드가 끝나면 로비가 바로 열려요.',
      },
    ],
    ...
    wayFileBody: '언제든, 설치 없이 사용할 수 있어요. 팩이라면 업로드가 끝나자마자 로비가 열려요.',
    faqTitle: '자주 묻는 질문',
    faq: [
      {
        q: '어떤 형식을 지원하나요?',
        a: 'MP4만 가능해요. 거의 모든 다운로드·내보내기 도구가 이 형식을 지원해요. .mov, .mkv, .avi는 HandBrake 같은 도구로 몇 초 만에 MP4로 바꿀 수 있어요. iPhone에서는 설정 › 카메라 › 포맷에서 「높은 호환성」을 선택하세요.',
      },
      {
    ...
    finalBody: '카탈로그에서 장면을 고르고 영상을 MP4로 준비하면 로비가 바로 열려요.',
    homeLead: '영상이 유튜브, 틱톡, 아니면 내 디스크에 있나요?',
    homeAction: '불러오는 방법 보기',
    createLink: '영상 파일은 어떻게 구하나요?',
    homeBannerTitle: '어떤 영상이든, MP4로',
    homeBannerBody: 'YouTube, TikTok, 내 디스크의 영화, 화면 녹화까지. MP4 파일이라면 모두 가져올 수 있어요. 가이드에서 5분 만에 구하고 준비하는 방법을 알려 드려요.',
    homeBannerAction: '불러오기 가이드 읽기',
    midLink: '아직 영상이 없나요? 가이드에서 구하는 방법을 설명합니다.',
    trajetFile: 'MP4 · 최대 50MB',
  },
  ...
  creators: {
    ...
    statScenes: '플레이한 장면',
    statCharacters: '더빙한 캐릭터',
    topCharacterTitle: '가장 많이 더빙한 캐릭터',
    topCharacterBody: (duree: string, n: number) => `${n}개 장면에서 총 ${duree}`,
    topCharacterNone: '아직 완료한 장면이 없어요.',
  },
