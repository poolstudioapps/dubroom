...
export const ko = {
  ...
  home: {
    ...
    faqExtra: [
      ...
      {
        q: '중간에 쉬면 어떻게 되나요?',
        a: '20분 동안 아무 활동이 없는 로비나 스튜디오는 방치된 장면이 쌓이지 않도록 자동으로 닫혀요. 로비는 호스트가 다시 열 수 있고, 스튜디오라면 새 장면을 시작하세요.',
      },
      {
        q: '목소리와 음악은 어떻게 나누나요?',
  ...
  lobby: {
    ...
    closedBody: '이 로비는 20분 동안 활동이 없어 자동으로 닫혔고, 이제 아무도 참여할 수 없어요.',
    closedHost: '20분 더 다시 열거나, 장면 목록에서 장면을 삭제할 수 있어요.',
  ...
  guideHub: {
    ...
    tips: [
      ...
      {
        title: '20분 멈추면 자동 종료',
        body: '20분 동안 활동이 없는 로비나 스튜디오는 자동으로 닫혀요.',
      },
      {
        title: '영상은 빨리 내려받기',
  ...
  guides: {
    ...
    prepare: {
      ...
      steps: [
        ...
        {
          title: '로비 열기',
          body: '코드나 링크를 공유하세요. 각자 캐릭터를 고르고, 아무도 고르지 않은 역할은 원래 목소리를 유지해요. 로비는 20분 동안 활동이 없으면 자동으로 닫혀요.',
        },
      ],
