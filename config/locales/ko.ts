...
export const ko = {
  ...
  home: {
    ...
    faqExtra: [
      {
        q: '무료인가요?',
        a: '네. Dub’Up은 개인 프로젝트로, 광고도 구독도 없고 장면 수 제한도 없어요.',
      },
      {
        q: '커뮤니티는 뭔가요?',
        a: '다른 플레이어가 미리 준비한 장면 카탈로그예요. 캐릭터, 대본, 구간이 모두 준비되어 있어요. 영상만 가져오면 몇 분 안에 로비가 열려요. 영상과 목소리는 절대 공유되지 않아요.',
      },
      {
        q: '일반 영상 편집과 무엇이 다른가요?',
        a: '편집 프로그램은 빈 타임라인에서 시작해요. Dub’Up은 장면에서 출발해 목소리와 음악을 나누고, 대사를 찾아 캐릭터에 배정하고, 테이크 위치까지 알아서 맞춰요.',
      },
      {
    ...
    faq: [
      ...
      {
        q: '마지막에 무엇이 남나요?',
        a: '여러분의 목소리가 담긴 영상이요. 한 시간 동안 내려받고 공유할 수 있고, 그 뒤에는 녹음과 원본 영상처럼 삭제돼요. 서버에는 아무것도 남지 않아요.',
      },
      {
        q: '아무나 초대할 수 있나요?',
  ...
  sessions: {
    ...
    storageHelp:
      '최종 영상이 준비되면 원본 영상과 녹음은 바로 삭제돼요. 공간을 차지하는 건 최종 영상뿐이고, 그것도 한 시간뿐이에요.',
