...
export const ko = {
  ...
  packStart: {
    intro: '이 장면은 링크로 저장되어 있어 영상을 다시 가져와야 합니다. 방법은 두 가지입니다.',
    recommended: '추천',
    fileTitle: '영상 직접 가져오기',
    fileBody: '장면의 YouTube 영상을 준비해 여기에 파일을 놓으세요. 호스트 PC 없이 온라인에서 약 2분 만에 준비됩니다. 팩의 대사와 캐릭터는 그대로 사용됩니다.',
    openSource: 'YouTube에서 영상 보기',
    howTo: '파일은 어떻게 준비하나요?',
    drop: '여기에 영상을 놓거나 클릭해서 선택하세요',
    expected: (d: string) => `예상 길이: ${d} · MP4, 최대 50 MB`,
    mismatch: (expected: string, got: string) => `이 파일은 ${got}, 팩의 장면은 ${expected}입니다. 정확히 같은 영상이 아니면 대사 위치가 어긋납니다.`,
    tooLarge: '파일이 너무 큽니다(최대 50 MB). 720p 또는 480p로 준비하세요.',
    fileSubmit: '가져와서 더빙하기',
    or: '또는',
    autoTitle: '자동 다운로드',
  ...
  guide: {
    metaTitle: '내 영상으로 장면 더빙하기',
    kicker: '가이드',
    heroTitle: '카탈로그 장면을 내 영상으로 더빙하기',
    heroBody: '카탈로그 장면에는 YouTube 링크와 준비 작업만 남아 있습니다. 더빙하려면 영상이 필요합니다. 가장 쉬운 방법은 직접 영상을 준비해 가져오는 것. 4단계, 5분이면 됩니다.',
    ctaPrimary: '장면 고르기',
    ctaSecondary: '왜 이 단계가 필요한가요?',
    stepsTitle: '4단계로',
    steps: [
      {
        title: 'YouTube에서 장면 열기',
        body: '커뮤니티에서 더빙할 장면을 열고 「YouTube에서 영상 보기」 링크를 따라가세요. 페이지 주소를 복사합니다.',
      },
      {
        title: '파일 준비하기',
        body: '원하는 다운로드 도구에 주소를 붙여 넣고 MP4로 저장하세요. 720p, 파일이 50 MB를 넘으면 480p를 고르세요.',
      },
      {
        title: '길이 확인하기',
        body: '팩과 정확히 같은 영상이어야 합니다. 시작도 끝도 같아야 해요. Dub’Up이 길이를 비교해 다르면 알려 줍니다.',
      },
      {
        title: '가져와서 더빙하기',
        body: '장면으로 돌아와 「영상 직접 가져오기」에 파일을 놓으세요. 준비는 온라인에서 진행되고, 그다음 로비가 열립니다.',
      },
    ],
    ...
    faq: [
      {
        q: '어떤 도구로 내려받나요?',
        a: 'YouTube 영상을 MP4로 저장할 수 있는 도구면 무엇이든 됩니다. 확장 프로그램이나 알 수 없는 프로그램 설치를 요구하는 것은 피하고, 개인적으로 사용할 권리가 있는 영상만 내려받으세요.',
      },
      {
        q: '파일이 50 MB를 넘어요',
        a: '더 낮은 화질로 내려받으세요. 720p, 긴 장면이라면 480p. 스튜디오에서 화면은 충분히 선명하고 소리도 손상되지 않습니다.',
      },
      {
        q: '대사 위치가 어긋나요',
        a: '팩과 정확히 같은 영상이 아닙니다. 인트로가 더 있거나, 끝이 잘렸거나, 다른 업로드일 수 있어요. 팩의 링크로 그 영상을 준비하세요.',
      },
      {
        q: '영상이 YouTube에서 사라졌어요',
        a: '원본 영상이 없으면 그 장면은 더빙할 수 없습니다. 다른 버전을 새 장면으로 가져오면 처음부터 준비됩니다.',
      },
    ],
