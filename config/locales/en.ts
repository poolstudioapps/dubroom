...
export const en = {
  ...
  home: {
    ...
    faqExtra: [
      ...
      },
      {
        ...
        a: 'The catalogue of scenes already prepared by other players: characters, text, timing and sound are ready. Bring the video as an MP4 and the lobby opens right away. Videos and your voices are never shared.',
      },
      {
  ...
  community: {
    ...
    recipeHelp: 'Videos are not hosted here: each scene keeps its timing and original sound. To dub one, bring its video as an MP4 and the lobby opens right away.',
  ...
  create: {
    ...
    wrongType: 'Only MP4 files are accepted. Convert your video to MP4: the import guide shows how.',
    ...
    introPack: 'Characters, lines and sound are ready: bring the video as an MP4 and the lobby opens right away.',
    introYoutube: 'Administrators only: the video is fetched by the host’s computer, which must be switched on.',
    limits: 'MP4 file · 50 MB and 10 minutes at most',
  ...
  packStart: {
    ...
    fileBody: 'Drop the scene’s video as an MP4: the lobby opens as soon as the upload finishes. The pack’s text and characters are kept as they are.',
    openSource: 'See the original video',
    howTo: 'How do I get the file?',
    drop: 'Drop the video here, or click to choose it',
    expected: (d: string) => `Expected duration: ${d} · MP4, 50 MB max`,
    ...
    introMember: 'The catalogue keeps this scene’s timing and sound: bring its video as an MP4 and the lobby opens right away.',
  ...
  guide: {
    ...
    heroBody: 'Dubblers imports MP4 files, wherever they come from: YouTube, TikTok, a film on your drive, a screen recording. Catalogue scenes keep their timing and sound, not the picture: to dub one, you bring the video. Four steps, five minutes.',
    ...
    steps: [
      ...
      {
        title: 'Get the file',
        body: 'Save the video as an MP4 with the tool of your choice, or convert a file you already have. Aim for 720p, or 480p if the file is over 50 MB.',
      },
      {
      ...
      },
      {
        ...
        body: 'Go back to the scene and drop the file there. The lobby opens as soon as the upload finishes.',
      },
    ],
    ...
    wayFileBody: 'Works any time, nothing to install. For a pack, the lobby opens as soon as the upload finishes.',
    faqTitle: 'Frequently asked questions',
    faq: [
      {
        q: 'Which formats are accepted?',
        a: 'MP4 only, the format almost every download and export tool produces. A .mov, .mkv or .avi converts to MP4 in seconds with a tool like HandBrake; on iPhone, choose “Most Compatible” in Settings › Camera › Formats.',
      },
      {
    ...
    finalBody: 'Pick a scene in the catalogue, get its video as an MP4, and the lobby opens right away.',
    ...
    homeBannerTitle: 'Any video, as an MP4',
    homeBannerBody: 'YouTube, TikTok, a film on your drive, a screen recording: everything imports, as long as it is an MP4 file. The guide shows how to get it and prepare it in five minutes.',
    homeBannerAction: 'Read the import guide',
    midLink: 'No video at hand yet? The guide explains how to get one.',
    trajetFile: 'MP4 · 50 MB max',
  },
  ...
  creators: {
    ...
    statScenes: 'Scenes played',
    statCharacters: 'Characters dubbed',
    topCharacterTitle: 'Most dubbed character',
    topCharacterBody: (duree: string, n: number) => `${duree} of dubbing across ${n} scene${n > 1 ? 's' : ''}`,
    topCharacterNone: 'No finished scene yet.',
  },
