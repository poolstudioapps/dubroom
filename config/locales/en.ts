...
export const en = {
  ...
  packStart: {
    intro: 'This scene is kept as a link: its video has to be fetched again. There are two ways to do it.',
    recommended: 'Recommended',
    fileTitle: 'Import the video yourself',
    fileBody: 'Get the scene’s YouTube video, then drop the file here. Everything is prepared online in about two minutes, without the host’s PC. The pack’s text and characters are reused as they are.',
    openSource: 'Watch the video on YouTube',
    howTo: 'How do I get the file?',
    drop: 'Drop the video here, or click to choose it',
    expected: (d: string) => `Expected length: ${d} · MP4, 50 MB maximum`,
    ...
    tooLarge: 'File too heavy: 50 MB maximum. Get the video in 720p or 480p.',
  ...
  guide: {
    metaTitle: 'Dub a scene with your own video',
    kicker: 'Guide',
    heroTitle: 'Dub a catalogue scene with your own video',
    heroBody: 'Catalogue scenes only keep the YouTube link and the preparation work. To dub one, you need the video again. The simplest way: get it yourself, then import it. Four steps, five minutes.',
    ctaPrimary: 'Choose a scene',
    ctaSecondary: 'Why this step?',
    stepsTitle: 'In four steps',
    steps: [
      {
        title: 'Open the scene on YouTube',
        body: 'In Community, open the scene you want to dub and follow the “Watch the video on YouTube” link. Copy the page address.',
      },
      {
        title: 'Get the file',
        body: 'Paste the address into the download tool of your choice and save the video as MP4. Pick 720p, or 480p if the file is over 50 MB.',
      },
      {
        title: 'Check the length',
        body: 'The video must be exactly the pack’s one: same start, same end. Dub’Up compares the length and warns you if it differs.',
      },
      {
        title: 'Import and dub',
        body: 'Back on the scene, drop the file into “Import the video yourself”. Preparation runs online, then the lobby opens.',
      },
    ],
    ...
    faq: [
      {
        q: 'Which tool should I use to download?',
        a: 'Any tool that saves a YouTube video as MP4. Avoid those asking you to install an extension or unknown software, and only download videos you are allowed to use privately.',
      },
      {
        q: 'My file is over 50 MB',
        a: 'Download it in a lower quality: 720p, or 480p for a long scene. The picture stays sharp in the studio, and the sound does not suffer.',
      },
      {
        q: 'The lines land in the wrong place',
        a: 'The video is not exactly the pack’s one: an extra intro, a cut ending, or another upload. Use the pack’s link and get that one.',
      },
      {
        q: 'The video is no longer on YouTube',
        a: 'Without the original video, the scene cannot be dubbed. Import another version as a new scene: it will be prepared from scratch.',
      },
    ],
