...
export const ja = {
  ...
  home: {
    ...
    faqExtra: [
      {
        q: '無料ですか？',
        a: 'はい。Dub’Upは個人プロジェクトで、広告もサブスクリプションもなく、シーン数の制限もありません。',
      },
      {
        q: 'コミュニティとは？',
        a: 'ほかのプレイヤーが準備済みのシーンのカタログです。キャラクター、台本、区切りはすでに用意されています。動画を持ち込めば数分でロビーが開きます。動画や声が共有されることはありません。',
      },
      {
        q: '普通の動画編集との違いは？',
        a: '編集ソフトでは空のタイムラインから始めます。Dub’Upはシーンから出発し、声と音楽を分け、セリフを見つけてキャラクターに割り当て、テイクの位置も自動で合わせます。',
      },
      {
        q: '別の言語のシーンも吹き替えられる？',
    ...
    faq: [
      ...
      {
        q: '最後に何が残る？',
        a: 'みんなの声が入った動画で、1時間ダウンロードと共有ができます。その後は録音や元の動画と同じく削除され、サーバーには何も残りません。',
      },
      {
        q: '誰でも招待できる？',
  ...
  sessions: {
    ...
    storageTitle: '使用中の容量',
    storageHelp:
      '完成動画ができた時点で、元の動画と録音は削除されます。容量を使うのは完成動画だけで、それも1時間だけです。',
