...
export const ja = {
  ...
  create: {
    ...
    keepHelpUpload:
      'コミュニティに公開できるのはリンクから作ったシーンだけです。読み込んだファイルはグループ内だけの非公開のままで、作品そのものを再配信することはありません。',
  ...
  studio: {
    fxNoTake: 'まずこのセリフを録音してください。エフェクトはそのテイクにかけられます。',
    ...
    fxTune: '音程補正',
    fxHelp:
      'エフェクトは表示中のテイクだけに適用されます。録音そのものではなくミックス時にかかるので、書き出しまでいつでも変更・解除できます。',
    fxPresets: {
      dry: '素の声',
      room: '小さな部屋',
      cathedral: '大聖堂',
  ...
  packStart: {
    intro: 'このシーンはリンクとして保存されています。動画をもう一度用意する必要があります。方法は二つです。',
    recommended: 'おすすめ',
    fileTitle: '動画を自分でインポート',
    fileBody: 'シーンのYouTube動画を用意して、ここにファイルをドロップしてください。ホストのPCなしで、約2分でオンライン準備が完了します。パックのセリフとキャラクターはそのまま使われます。',
    openSource: 'YouTubeで動画を見る',
    howTo: 'ファイルの用意のしかた',
    drop: 'ここに動画をドロップ、またはクリックして選択',
    expected: (d: string) => `想定の長さ：${d}・MP4、最大50 MB`,
    mismatch: (expected: string, got: string) => `このファイルは${got}、パックのシーンは${expected}です。まったく同じ動画でないと、セリフの位置がずれます。`,
    tooLarge: 'ファイルが大きすぎます（最大50 MB）。720pか480pで用意してください。',
  ...
  guide: {
    metaTitle: '自分の動画でシーンを吹き替える',
    kicker: 'ガイド',
    heroTitle: 'カタログのシーンを自分の動画で吹き替える',
    heroBody: 'カタログのシーンに残っているのは、YouTubeのリンクと準備の内容だけです。吹き替えるには動画が必要です。いちばん簡単なのは、自分で動画を用意してインポートすること。4ステップ、5分です。',
    ctaPrimary: 'シーンを選ぶ',
    ctaSecondary: 'なぜこの手順が必要？',
    stepsTitle: '4つのステップ',
    steps: [
      {
        title: 'YouTubeでシーンを開く',
        body: 'コミュニティで吹き替えたいシーンを開き、「YouTubeで動画を見る」のリンクをたどります。ページのアドレスをコピーしてください。',
      },
      {
        title: 'ファイルを用意する',
        body: 'お好みのダウンロードツールにアドレスを貼り付け、MP4で保存します。720p、50 MBを超える場合は480pを選んでください。',
      },
      {
        title: '長さを確認する',
        body: 'パックとまったく同じ動画である必要があります。始まりも終わりも同じ。Dub’Upが長さを比べ、違えば知らせます。',
      },
      {
        title: 'インポートして吹き替える',
        body: 'シーンに戻り、「動画を自分でインポート」にファイルをドロップします。準備はオンラインで進み、そのあとロビーが開きます。',
      },
    ],
    ...
    faq: [
      {
        q: 'ダウンロードにはどのツールを使えばいい？',
        a: 'YouTube動画をMP4で保存できるものなら何でも構いません。拡張機能や不明なソフトのインストールを求めるものは避け、私的に使う権利のある動画だけをダウンロードしてください。',
      },
      {
        q: 'ファイルが50 MBを超える',
        a: '画質を下げてダウンロードしてください。720p、長いシーンなら480p。スタジオでは十分きれいに見え、音質も落ちません。',
      },
      {
        q: 'セリフの位置がずれる',
        a: 'パックとまったく同じ動画ではありません。イントロが長い、終わりが切れている、別のアップロードなどです。パックのリンクからその動画を用意してください。',
      },
      {
        q: '動画がYouTubeから消えている',
        a: '元の動画がなければ、そのシーンは吹き替えできません。別のバージョンを新しいシーンとしてインポートすれば、一から準備されます。',
      },
    ],
