...
export const ja = {
  ...
  home: {
    ...
    faqExtra: [
      ...
      {
        q: 'コミュニティとは？',
        a: 'ほかのプレイヤーが準備したシーンのカタログです。キャラクター、台本、区切り、音声がそろっています。動画をMP4で用意すれば、ロビーがすぐに開きます。動画やみんなの声が共有されることはありません。',
      },
      {
        q: '普通の動画編集との違いは？',
      ...
      {
        q: '途中で休憩したら？',
        a: '30分間何も操作がないロビーやスタジオは、放置されたシーンが残らないよう自動で閉じます。ロビーはホストが再開できますが、スタジオの場合は新しいシーンを始めてください。',
      },
      {
        q: '声と音楽はどうやって分けるの？',
  ...
  community: {
    ...
    kindRecipe: 'レシピ',
    kindMedia: 'ファイル保管',
    recipeHelp: '動画はここには保存されません。各シーンは区切りと元の音声だけを保存しています。吹き替えるには、動画をMP4で用意すればロビーがすぐに開きます。',
  ...
  create: {
    ...
    wrongType: 'MP4ファイルのみ対応しています。動画をMP4に変換してください。方法はインポートガイドにあります。',
    youtubeLabel: '動画のリンク',
    ...
    introPack: 'キャラクター、セリフ、音声はすでに準備済み。動画をMP4で用意すれば、ロビーがすぐに開きます。',
    introYoutube: '管理者専用：動画はホストのパソコンがダウンロードします。電源を入れておいてください。',
    limits: 'MP4ファイル・最大50MB・10分',
    uploadStepsTitle: '流れ',
    uploadSteps: [
      '動画を選んでタイトルを付けます。',
  ...
  prepare: {
    ...
    cutLine: 'セリフを分割',
    cutHelp: '2つの単語の間をクリックして分割します。後半は別のセリフになり、ほかのキャラクターに割り当てられます。',
    cutAfter: (mot: string) => `「${mot}」の後で分割`,
    cutSecondBy: '後半を話すキャラクター',
    cutConfirm: '分割',
  },
  ...
  lobby: {
    ...
    closedBody: 'このロビーは30分間操作がなかったため自動的に閉じられ、誰も参加できなくなりました。',
    closedHost: 'もう30分間開き直すか、シーン一覧からシーンを削除できます。',
  ...
  studio: {
    ...
    expiredBody: '30分間テイクが録音されなかったため、セッションは自動的に終了しました。いつでも新しく始められます。',
    expiredOk: 'OK',
    takeDragHelp: 'テイクを配置しました。ずらすには、波形の上でトラックをドラッグしてください。',
    allTakesSavedStay: 'すべてのテイクを保存しました。聞き直したり録り直したりして、準備ができたら終了してください。',
    castTitle: 'キャスト',
    waitingSubtitle: 'テイクは保存済みです。誰がどのキャラクターを担当し、みんながどこまで進んでいるかを確認できます。',
    keptVo: '元の声のまま',
    noRole: '担当なし',
    fxKeepCharacter: (nom: string) => `${nom}にこの設定を保持`,
    fxKeepCharacterHelp: 'ピッチ、リバーブ、音量：このキャラクターの新しいテイクすべてに適用されます。',
  },
  ...
  packStart: {
    ...
    fileBody: 'シーンの動画をMP4でドロップしてください。アップロードが終わるとすぐにロビーが開きます。パックのテキストとキャラクターはそのまま使われます。',
    openSource: '元の動画を見る',
    howTo: 'ファイルの用意のしかた',
    drop: 'ここに動画をドロップ、またはクリックして選択',
    expected: (d: string) => `想定の長さ：${d}・MP4、最大50MB`,
    ...
    introMember: 'このシーンの区切りと音声はカタログに保存されています。動画をMP4で用意すれば、ロビーがすぐに開きます。',
  ...
  guide: {
    ...
    heroBody: 'DubblersはMP4ファイルなら入手元を問わず読み込めます。YouTube、TikTok、ディスク上の映画、画面録画など。カタログのシーンに保存されているのは区切りと音声で、映像はありません。吹き替えるには動画を持ち込みます。4ステップ、5分です。',
    ctaPrimary: 'シーンを選ぶ',
    ...
    steps: [
      ...
      {
        title: 'ファイルを用意する',
        body: 'お好きなツールで動画をMP4として保存するか、手元のファイルをMP4に変換してください。目安は720p、50MBを超える場合は480pです。',
      },
      {
        title: '長さを確認する',
      ...
      {
        title: '読み込んで吹き替える',
        body: 'シーンに戻り、ファイルをドロップします。アップロードが終わるとすぐにロビーが開きます。',
      },
    ],
    ...
    wayFileBody: 'いつでも使え、インストールも不要です。パックならアップロードが終わるとすぐにロビーが開きます。',
    faqTitle: 'よくある質問',
    faq: [
      {
        q: '対応している形式は？',
        a: 'MP4のみです。ほとんどのダウンロード・書き出しツールがこの形式に対応しています。.mov、.mkv、.aviはHandBrakeなどのツールで数秒でMP4に変換できます。iPhoneでは「設定 › カメラ › フォーマット」で「互換性優先」を選んでください。',
      },
      {
    ...
    finalBody: 'カタログからシーンを選び、動画をMP4で用意すれば、ロビーがすぐに開きます。',
    homeLead: '動画は YouTube、TikTok、それともディスクから？',
    homeAction: '読み込み方を見る',
    createLink: '動画ファイルの入手方法は？',
    homeBannerTitle: 'どんな動画も、MP4で',
    homeBannerBody: 'YouTube、TikTok、ディスク上の映画、画面録画。MP4ファイルならすべて読み込めます。入手と準備の方法を、ガイドで5分で紹介します。',
    homeBannerAction: '読み込みガイドを読む',
    midLink: 'まだ動画がない？入手方法はガイドで説明しています。',
    trajetFile: 'MP4・最大50MB',
  },
  ...
  guideHub: {
    ...
    tips: [
      ...
      {
        title: '30分放置で自動終了',
        body: '30分間操作がないロビーやスタジオは自動的に閉じます。',
      },
      {
        title: '動画は早めにダウンロード',
  ...
  guides: {
    ...
    prepare: {
      ...
      steps: [
        ...
        {
          title: 'ロビーを開く',
          body: 'コードかリンクを共有します。各自がキャラクターを選び、誰も選ばなかった役は元の声のまま。ロビーは30分間操作がないと自動で閉じます。',
        },
      ],
  ...
  creators: {
    ...
    statScenes: 'プレイしたシーン',
    statCharacters: '吹き替えたキャラクター',
    topCharacterTitle: 'いちばん吹き替えたキャラクター',
    topCharacterBody: (duree: string, n: number) => `${n}シーンで合計${duree}`,
    topCharacterNone: 'まだ完了したシーンはありません。',
  },
