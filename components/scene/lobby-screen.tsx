...
/** Un salon se ferme trente minutes apres son ouverture (voir `app_fermer_salons`). */
const SALON_DUREE_MS = 30 * 60 * 1000;
...
export function LobbyScreen() {
  ...
  /*
   * Un salon oublie se ferme apres trente minutes (voir `app_fermer_salons`).
  ...
  return (
    <div className="space-y-6">
      {/*
        Le titre sort de la colonne principale : sur telephone celle-ci
        passe apres le panneau de droite, et on tombait sur « Lancer la
        ...
        <aside className="order-first space-y-4 lg:order-none">
          ...
          {isHost ? (
            <Card className="space-y-3">
              ...
              {/*
              Deux encarts identiques empiles se lisaient comme deux
              reproches. Un seul, qui nomme les personnages et les joueurs
              en cause : on sait alors qui attendre.
            */}
              {canStart ? null : (
                <Alert tone="warn">
                  <p className="font-bold">{t.lobby.startBlockedTitle}</p>
