...
export function HomePacksCta() {
  ...
  return (
    <Card className="flex flex-wrap items-center justify-between gap-4">
      ...
      <Link
        href="/sessions/new"
        className="btn-3d inline-flex h-11 shrink-0 items-center justify-center gap-2 bg-surface-raised px-5 text-sm font-semibold uppercase tracking-wide text-text [--btn-lip:var(--color-border-strong)]"
      >
